...
export default function Profile() {
  ...
  return (
    <motion.div 
      ...
      className="min-h-full bg-[#E8EDEE] pb-32 flex flex-col"
    >
      {/* Header Section */}
      <div className="bg-gradient-mood px-6 pt-16 pb-8 rounded-b-[40px] shadow-sm relative">
        <div className="absolute top-16 right-6 flex gap-3">
          <button 
            ...
            className="w-10 h-10 bg-white/30 backdrop-blur-md rounded-full flex items-center justify-center text-black"
          >
            <Settings size={20} />
          </button>
          <button 
